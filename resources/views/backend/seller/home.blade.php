                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                        <div class="scroller" style="height: 250px;" data-always-visible="1" data-rail-visible="0">
                                            <ul class="feeds">
                                                @if($pendingDueToVendor == null || $pendingDueToVendor == "")
                                                    <div class="col1">
                                                        <div class="cont">
                                                            <div class="cont-col2">
                                                ...
                                                @else
                                                    @foreach($pendingDueToVendor as $value)
                                                        <li>
                                                            <div class="row">
                                                                <div class="col-md-1">
                                ...
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                        <div class="scroller" style="height: 250px;" data-always-visible="1" data-rail-visible="">
                                            <ul class="feeds">
                                                @if($pendingForVendorCancelation == null || $pendingForVendorCancelation == "")
                                                    <div class="col1">
                                                        <div class="cont">
                                                            <div class="cont-col2">
                                                ...
                                                @else
                                                    @foreach($pendingForVendorCancelation as $value)
                                                        <li>
                                                            <div class="row">
                                                                <div class="col-md-1">
                                                                    <div class="label label-sm label-info">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                        <div class="scroller" style="height: 250px;" data-always-visible="1" data-rail-visible="0">
                                            <ul class="feeds">
                                                @if($pendingForCustomerCancelation == null || $pendingForCustomerCancelation == "")
                                                    <div class="col1">
                                                        <div class="cont">
                                                            <div class="cont-col2">
                                                ...
                                                @else
                                                    @foreach($pendingForCustomerCancelation as $value)
                                                        <li>
                                                            <div class="row">
                                                                <div class="col-md-1">
                                                                    <div class="label label-sm label-info">
                            ...
                            <div class="col-md-6 col-sm-6">
                                <div class="portlet light bordered">
                                    ...
                                    <div class="portlet-body">
                                        <div class="scroller" style="height: 250px;" data-always-visible="1" data-rail-visible="0">
                                            <ul class="feeds">
                                                @if($customerIssue == null || $customerIssue == "")
                                                    <div class="col1">
                                                        <div class="cont">
                                                            <div class="cont-col2">
                                                ...
                                                @else
                                                    @foreach($customerIssue as $value)
                                                        <li>
                                                            <div class="row">
                                                                <div class="col-sm-1">
                                                                    <div class="label label-sm label-info">
