...
<script src="/assets/pages/scripts/ecommerce-queries.min.js" type="text/javascript"></script>
<!-- END PAGE LEVEL SCRIPTS -->
<script src="/assets/custom/common/js/query-conversation-data.js" type="text/javascript"></script>
