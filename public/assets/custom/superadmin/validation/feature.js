...
$("form").on("click", ".new-option", function (e) {
    e.preventDefault();
    $("#feature_extra").append(" <tr class='feature-options'><td><input type='text' class='work_emp_name' name='feature_option[]' value=''></td><td><button class='btn red btn-remove' >Remove</button></td></tr>");
