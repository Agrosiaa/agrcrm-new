$(document).ready(function () {
                ...
                if(xhr.status == 200){
                    ...
                    if(xhr.status == 204){
                        ...
                        if($(".btn-address").parents(".checkout-item").hasClass("active")){
                            ...
                            var index = $(".btn-address").parents(".checkout-item").index();
                            $(".checkout-steps ul li").nextAll().removeClass("completed").removeClass("active");
    ...
    $(document).on("click",".checkout-steps ul li.completed",function(){
        ...
        if(stepscount == 1){
            ...
            if(indexCount == 0){
                ...
                $(".checkout-items-wrap .checkout-item").eq($(this).index()).addClass("active").removeClass("completed");
                $(".checkout-items-wrap .checkout-item").eq(0).addClass("completed").removeClass("active");
            }
        }
        else if(stepscount == 2){
            var indexCount = $(this).index();
            if(indexCount == 0){
                $(".checkout-items-wrap .checkout-item").eq($(this).index()).addClass("active").removeClass("completed");
                $(".checkout-items-wrap .checkout-item").eq(1).addClass("completed").removeClass("active");
                $(".checkout-items-wrap .checkout-item").eq(2).removeClass("active").addClass("completed");
            }
            else if (indexCount == 1) {
                $(".checkout-items-wrap .checkout-item").eq($(this).index()).addClass("active").removeClass("completed");
                $(".checkout-items-wrap .checkout-item").eq(0).addClass("completed").removeClass("active");
            ...
            if(indexCount == 0){
                ...
                $(".checkout-items-wrap .checkout-item").eq(1).addClass("completed").removeClass("active");
                $(".checkout-items-wrap .checkout-item").eq(2).removeClass("active").addClass("completed");
                $(".checkout-items-wrap .checkout-item").eq(3).removeClass("active").addClass("completed");
            ...
            if(indexCount == 2){
                $(".checkout-items-wrap .checkout-item").eq($(this).index()).addClass("active").removeClass("completed");
                $(".checkout-items-wrap .checkout-item").eq(1).addClass("completed").removeClass("active");
                $(".checkout-items-wrap .checkout-item").eq(0).removeClass("active").addClass("completed");
                $(".checkout-items-wrap .checkout-item").eq(3).removeClass("active").addClass("completed");
            }
            if(indexCount == 3){
                $(".checkout-items-wrap .checkout-item").eq($(this).index()).addClass("active").removeClass("completed");
    ...
    $(document).on("click",".checkout-item .title a",function(){
        if(stepscount == 1){
            var index = $(this).parents(".checkout-item").index();
            if(index == 0){
